...
export const waermepumpenFAQ: FAQItem[] = [
  {
    question: "Welche Wärmepumpe ist die richtige für mein Haus?",
    answer:
      "Das hängt von mehreren Faktoren ab: Grundstücksgröße, Bodenbeschaffenheit, Gebäudedämmung und Budget. Luft-Wasser-Wärmepumpen sind am vielseitigsten einsetzbar, Erdwärmepumpen am effizientesten. Wir beraten Sie gerne individuell.",
  },
  {
    question: "Wie laut ist eine Wärmepumpe?",
    answer:
      "Moderne Luft-Wasser-Wärmepumpen erreichen Schallpegel von 35–50 dB(A) — vergleichbar mit einem leisen Gespräch. Sole-Wasser- und Wasser-Wasser-Wärmepumpen sind praktisch lautlos, da sie kein Außengerät benötigen.",
  },
  {
    question: "Wie hoch sind die Betriebskosten einer Wärmepumpe?",
    answer:
...
export const photovoltaikFAQ: FAQItem[] = [
  {
